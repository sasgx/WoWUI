  ...
  t:SetTexture("Interface\\AddOns\\SasUI\\media\\zahnrad")
  local adjust = 1.22
  ...
  t:SetTexture("Interface\\AddOns\\SasUI\\media\\map_gloss")
  local adjust = 1.06
  ...
  t:SetTexture("Interface\\AddOns\\SasUI\\media\\map_overlay")
  local adjust = 1.3
  t:SetPoint("CENTER", 0, 0)
  ...
  t:SetTexture("Interface\\AddOns\\SasUI\\media\\ring")
  local adjust = 1.10
  t:SetPoint("CENTER", 0, 0)
  t:SetWidth(Minimap:GetHeight()*adjust)
  t:SetHeight(Minimap:GetHeight()*adjust)
  ...
  local t = Minimap:CreateTexture(nil,"ARTWORK",nil,2)
  t:SetTexture("Interface\\AddOns\\SasUI\\media\\map_innershadow")
  local adjust = 1.06
  t:SetPoint("CENTER", 0, 0)
  t:SetWidth(Minimap:GetHeight()*adjust)
  t:SetHeight(Minimap:GetHeight()*adjust)
  ...
  MiniMapTrackingButtonBorder:SetTexture("Interface\\AddOns\\SasUI\\media\\button_overlay")
  ...
  --mail icon border
  MiniMapMailBorder:SetTexture("Interface\\AddOns\\SasUI\\media\\button_overlay")
  ...
  GameTimeFrameBorder:SetTexture("Interface\\AddOns\\SasUI\\media\\button_overlay")
  ...
  --border
  QueueStatusMinimapButtonBorder:SetTexture("Interface\\AddOns\\SasUI\\media\\button_overlay")
