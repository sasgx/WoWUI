  ...
  cfg.bars = {
    ...
    bar2 = {
      ...
      pos             = { a1 = "BOTTOM", a2 = "BOTTOM", af = "UIParent", x = -1, y = 173 },
      userplaced      = {
        enable          = true,
      },
      mouseover       = {
    ...
    bar3 = {
      ...
      pos             = { a1 = "BOTTOM", a2 = "BOTTOM", af = "UIParent", x = -1, y = 142 },
      userplaced      = {
        enable          = true,
      },
      mouseover       = {
    ...
    stancebar = {
      ...
      pos             = { a1 = "BOTTOM", a2 = "BOTTOM", af = "UIParent", x = -255, y = 222 },
      userplaced      = {
        enable          = true,
      },
      mouseover       = {
    ...
    extrabar = {
      ...
      pos             = { a1 = "BOTTOM", a2 = "BOTTOM", af = "UIParent", x = -220, y = 135 },
      userplaced      = {
        enable          = true,
      },
      mouseover       = {
    ...
    leave_vehicle = {
      ...
      pos             = { a1 = "BOTTOM", a2 = "BOTTOM", af = "UIParent", x = 215, y = 135 },
      userplaced      = {
        enable          = true,
      },
      mouseover       = {
    ...
    micromenu = {
      ...
      scale           = 0.82,
      padding         = 10, --frame padding
      pos             = { a1 = "TOPLEFT", a2 = "TOPLEFT", af = "UIParent", x = 25, y = 30 },
      userplaced      = {
        enable          = true,
      },
      mouseover       = {
    ...
    bags = {
      ...
      pos             = { a1 = "BOTTOMRIGHT", a2 = "BOTTOMRIGHT", af = "UIParent", x = -0, y = 152 },
      userplaced      = {
        enable          = true,
      },
      mouseover       = {
