...
for i=1,numf do
	...
	if(i==1)then
		...
		f:SetPoint("BOTTOM",66,207)
	elseif(i==2)then
		f:SetJustifyH(ct.justify_2)
		f:SetPoint("CENTER",-336,-182)
	elseif(i==3)then
		f:SetJustifyH(ct.justify_3)
		f:SetWidth(256)
		f:SetPoint("TOP",-2,-160)
	else
...
SlashCmdList["XCT"]=function(input)
	...
	elseif(input=="reset")then
		xCT1:ClearAllPoints()
		xCT1:SetPoint("BOTTOM",UIParent, "BOTTOM", 66, 207)
		xCT1:SetHeight(128)
		xCT1:SetWidth(128)
		xCT2:ClearAllPoints()
		xCT2:SetPoint("BOTTOM",UIParent, "BOTTOM", -65, 207)
		xCT2:SetHeight(128)
		xCT2:SetWidth(128)
		xCT3:ClearAllPoints()
		xCT3:SetPoint("TOP",UIParent, "TOP", -2, -160)
		xCT3:SetHeight(128)
		xCT3:SetWidth(256)
		xCT4:ClearAllPoints()
		xCT4:SetPoint("CENTER",UIParent, "CENTER", 336, -182)
		xCT4:SetHeight(128)
		xCT4:SetWidth(128)
	else
...
if(ct.damage)then
	...
	if(ct.icons)then
		ct.blank="Interface\\AddOns\\SasUI\\media\\blank"
	end
